                     ...
                     int       nCmdShow) 
{
	...
	hWnd = CreateWindowEx(dwExStyle, "DeferredRenderingClass",  "Deferred Rendering Shadow Mapping tutorial", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, width, height, NULL, NULL, hInstance, NULL);
